...
if __name__ == '__main__':
    ...
    dataloader, testloader, tokenizer = get_loaders(
        args.dataset, nsamples=args.nsamples, seed=args.seed, model=args.model, seqlen=model.seqlen, return_tokenizer=True
    )
    ...
    if args.save:
        ...
        # torch.save(model.state_dict(), os.path.join(args.save_dir, f'{args.model}_{args.wbits}bit')) 
        model.save_pretrained(os.path.join(args.save_dir, f'{args.model}_{args.wbits}bit'))
        tokenizer.save_pretrained(os.path.join(args.save_dir, f'{args.model}_{args.wbits}bit'))
