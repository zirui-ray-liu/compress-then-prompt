...
class BloomPromptTuningMixin:
    ...
    def initialize_soft_prompt(
        ...
        if initialize_from_vocab:
            init_prompt_value = self.transformer.word_embeddings.weight[:n_tokens].clone().detach()
        else:
...
class BloomPromptTuningLM(BloomPromptTuningMixin, BloomForCausalLM):
