...
from sparse_gpt import * 
from prompt.modelutils import *
from prompt.datautils import get_loaders
...
if __name__ == '__main__':
    ...
    if args.save:
        ...
        model.save_pretrained(os.path.join(args.save_dir, f'{args.model}_sp{args.sparsity}bit'))
        tokenizer.save_pretrained(os.path.join(args.save_dir, f'{args.model}_sp{args.sparsity}bit'))