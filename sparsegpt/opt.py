...
if __name__ == '__main__':
    ...
    if args.save:
        ...
        model.save_pretrained(os.path.join(args.save_dir, f'{args.model}_{args.sparsity}'))
        tokenizer.save_pretrained(os.path.join(args.save_dir, f'{args.model}_{args.sparsity}'))
